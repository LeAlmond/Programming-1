...
#define MAXPATIENT 35 // constant to define max amount of patients
#define MAXROOM 21 // constant to define max amount of rooms

#define PATIENT_EX "%-8d%-13s%-13s%-10s%-5d%-12s\n" // the format to export the patient struct
#define PATIENT_IN "%d %s %s %s %d %s"   // the format to accept the patient struct

#define ROOM_EX "\n%-4d%-11s%-5d%-7s%" // the format to export the room struct excluding patient id's
#define ROOM_IN "%d% s% d% s%" // the format to accept the room struct excluding patient id's
